...
| F2  | Commands  | The player can control the main character by issuing command-line commands following the syntaxes: command-name ([target-objects]* on [target-objects]*). Some of available command-names are the following:<br/>- Examine ([object/character]): <br/>    &emsp;Retrieve the description of the current location or  a specified object or character. <br/>- North/East/South/West:<br/>&nbsp;Move to the location north, east, south, or west of the current location.<br/>- Climb up/down [object] :<br/>&nbsp;Target a climbable object to move to the location above or below the current location.<br/>- Take [object] :<br/>&nbsp;Put a retrievable object into the main character’s inventory.<br/>- Use [object] (on [object/character]) :&emsp;<br/>Use an object (on something), this may consume it.<br/>- Talk to [character] :<br/>&nbsp;Interact with a specific character.<br/>- Equip [weapon/armor]:<br/>Equips a weapon or armor piece.<br/>- Attack [character]:<br/>&nbsp;Enter combat against a character.<br/>- Hint :<br/>&nbsp;Request a hint. |
